package com.example.kafkacloudstream.controllers;
    ...
    public Flux<Map<String, Long>> analytics() {
        return Flux.interval(Duration.ofSeconds(1))
                .map(sequence -> {
                    ...
                    ReadOnlyWindowStore<String, Long> windowStore = interactiveQueryService.getQueryableStore("page-event-count", QueryableStoreTypes.windowStore());
